...
public static class CollisionSceneSetup
{
    ...
    {
        CollisionSystemBootstrap.Initialize();
    ...
    public static void EnsurePlayerVehicles() => VehicleDeformationSetup.SetupAllVehicles();
    ...
    static bool ShouldConfigure(GameObject go)
    {
        ...
        if (go.GetComponent<CollisionReporter>() != null)
            return false;
